...
\node[anchor=north, inner sep=0](header) at (current page.north){\includegraphics[height=2.8cm, width=\paperwidth]{#1}};%
...
\newcommand{\cvevent}[7]{{#1} & \textbf{#2}\newline\textsc{#3} $\vdot$ #4\newline{\color{black!70}\footnotesize #5} #6{#7}}
\newcommand{\cvdegree}[6]{{#1} & \textbf{#2}\newline {#4}\newline{\color{black!70}\scriptsize #5}\vspace{0.5em} & \raisebox{-0.7\height}{#6}}
